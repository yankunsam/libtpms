...
/*            $Id: CryptSelfTest.c 55 2015-02-05 22:03:16Z kgoldman $		*/
/*										*/
...
// between commands.  This command may be canceled. If it is, then there is no return
// result. However, this command can be run again and the incremental progress will not be lost.
