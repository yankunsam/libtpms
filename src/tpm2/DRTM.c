...
/*            $Id: DRTM.c 110 2015-03-02 22:17:56Z kgoldman $			*/
/*										*/
...
// This file contains functions that simulate the DRTM events. Its primary purpose is to isolate the
// name space of the simulator from the name space of the TPM. This is only an issue with the
// parameters to _TPM_Hash_Data().
