...
/*            $Id: NV_spt.c 55 2015-02-05 22:03:16Z kgoldman $			*/
/*										*/
...
// 7.5.2	Fuctions
// 7.5.2.1	NvReadAccessChecks()	// Common routine for validating a read Used by TPM2_NV_Read(), TPM2_NV_ReadLock() and TPM2_PolicyNV()
