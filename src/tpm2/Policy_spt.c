...
/*            $Id: Policy_spt.c 55 2015-02-05 22:03:16Z kgoldman $		*/
/*										*/
		      ...
		      )
{
    ...
    if(nonce != NULL && nonce->t.size != 0)
	{
		...
		return TPM_RCS_NONCE + RC_PolicySigned_nonceTPM;
	}
    ...
    if(authTimeout != 0)
	{
		...
		return TPM_RCS_EXPIRED + nonceParameterNumber;
		...
		return TPM_RCS_EXPIRED + expirationParameterNumber;
	}
    ...
    if(cpHashA != NULL && cpHashA->t.size != 0)
	{
		...
		return TPM_RCS_SIZE + cpHashParameterNumber;
