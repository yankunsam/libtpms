...
/*            $Id: DA.c 471 2015-12-22 19:40:24Z kgoldman $			*/
/*										*/
...
// 8.2.3.2 DAInit() This function is called during _TPM_INIT() in order to make sure that the DA
// timers are reset when g_time is reset.
