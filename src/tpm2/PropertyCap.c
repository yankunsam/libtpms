...
/*            $Id: PropertyCap.c 471 2015-12-22 19:40:24Z kgoldman $		*/
/*										*/
...
//     All the fixed values are vendor dependent or determined by a platform-specific
//     specification. The values in the table below are examples and should be changed by the
//     vendor.
    ...
    switch(property)
	{
	  ...
	  case TPM_PT_MEMORY:
	    // a TPMA_MEMORY indicating the memory management method for the TPM
		  ...
		  // contains a UINT32, it will be properly aligned
