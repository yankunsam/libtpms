...
/*            $Id: NVMem.c 141 2015-03-16 17:08:34Z kgoldman $			*/
/*										*/
...
{
    platParameter = platParameter;                    // to keep compiler quiet
    ...
    else
	{
	    ...
	    (void)(fread(s_NV, NV_MEMORY_SIZE, 1, s_NVFile));
	}
#endif
